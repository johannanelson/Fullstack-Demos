...
var subtract5 = document.getElementById("subtract5");
var subtract25 = document.getElementById("subtract25");

// Dispatching actions
// Expects an action object as an argument
add5.onclick = function () {
  return store.dispatch({ type: "add", amount: 5 });
};
add25.onclick = function () {
  return store.dispatch({ type: "add", amount: 25 });
};
subtract5.onclick = function () {
  return console.log("Subtract 5");
};
subtract25.onclick = function () {
  return console.log("Subtract 25");
};
...
var reducerFunction = function reducerFunction() {
  var currentState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { total: 0 };
...
var store = (0, _redux.createStore)(reducerFunction);
